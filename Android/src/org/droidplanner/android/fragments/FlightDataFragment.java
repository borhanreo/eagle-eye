    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mGoToDroneLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               mapFragment.getCurrentFlightPoint();
                ...
                home = new GraphicHome(getDrone(), getContext());
                googleMapFragment.addMarker(home);
                googleMapFragment.updateCamera(new LatLong(33.5, 88.6), 50);*/
