...
public class DroidPlannerApp extends MultiDexApplication implements DroneListener, TowerListener, LinkListener {
    ...
    //private SocketDataReceiver socketDataReceiver2;
    ...
    public void onLinkStateUpdated(@NonNull LinkConnectionStatus connectionStatus) {
        switch (connectionStatus.getStatusCode()) {
            case LinkConnectionStatus.FAILED:
                ...
                Toast.makeText(getApplicationContext(), "Connection (No EagleEye) failed: " + errorMsg,
    ...
    public void connectToDrone() {
        ...
        // socket-connection << ferdib - al - islam

        //socketDataReceiver2 = new SocketDataReceiver(, context2, socketCallBackListener2);
    }
    ...
    // response from drone << ferdib- al - islam

    SocketCallBackListener socketCallBackListener2 = new SocketCallBackListener() {
        @Override
        public void backJsonString(String string, String data) {
