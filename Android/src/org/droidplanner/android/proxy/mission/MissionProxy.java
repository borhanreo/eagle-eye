...
public class MissionProxy implements DPMap.PathSource {
    ...
    private static  Context context_01;
    ...
    public MissionProxy(DroidPlannerApp app, Drone drone) {
        ...
        this.drone = drone;
        this.context_01=app.getApplicationContext();
    ...
    public void addWaypoints(List<LatLong> points) {
        ...
        //changing here
        List<LatLngDatabasesModel> latLonValue1 = new ArrayList<LatLngDatabasesModel>();
        ...
        for (LatLong point : points) {
            ...
            //changing here
            //latLonValue1.add(new LatLngDatabasesModel(point.getLatitude(),point.getLongitude(), (int) alt));
        }
        //changing here
        //SignletonLatLng.getInstance(context_01).setLatLngModel(latLonValue1);
    ...
    public static List<LatLong> getVisibleCoords(List<MissionItemProxy> mipList) {
        ...
        List<LatLngDatabasesModel> latLonValue = new ArrayList<LatLngDatabasesModel>();
        ...
        for (MissionItemProxy itemProxy : mipList) {
            ...
            //latLonValue.add(new LatLngDatabasesModel(coordinate.getLatitude(),coordinate.getLongitude(), 12));
        }
        //SignletonLatLng.getInstance(context_01).setLatLngModel(latLonValue);
